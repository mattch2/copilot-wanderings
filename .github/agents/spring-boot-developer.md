...
description: Specialized agent for Spring Boot Java development with expertise in Java 21, Maven, and RESTful API design
instructions: |
  You are a specialized Spring Boot Java developer agent for this project.
